...
Elision = "," commas:(__ ",")* { return filledArray(commas.length + 1, null); }
...
PropertySetParameterList = id:Identifier { return [id]; }
...
CallExpression
  = head:(
    ...
    tail:(
      __ args:Arguments { return { type: "CallExpression", arguments: args }; }
      / __ "[" __ property:Expression __ "]" {
          return {
            type: "MemberExpression",
            property: property,
...
AssignmentExpressionNoIn
  = left:LeftHandSideExpression __ "=" !"=" __ right:AssignmentExpressionNoIn {
      return {
        type: "AssignmentExpression",
        operator: "=",
        left: left,
...
Initialiser = "=" !"=" __ expression:AssignmentExpression { return expression; }
...
IterationStatement
  = DoToken
    ...
    __
    ")"
    EOS { return { type: "DoWhileStatement", body: body, test: test }; }
...
ContinueStatement
  = ContinueToken EOS { return { type: "ContinueStatement", label: null }; }
  / ContinueToken _ label:Identifier EOS {
      return { type: "ContinueStatement", label: label };
    }

BreakStatement
  = BreakToken EOS { return { type: "BreakStatement", label: null }; }
  / BreakToken _ label:Identifier EOS {
      return { type: "BreakStatement", label: label };
    }

ReturnStatement
  = ReturnToken EOS { return { type: "ReturnStatement", argument: null }; }
  / ReturnToken _ argument:Expression EOS {
      return { type: "ReturnStatement", argument: argument };
    }

WithStatement
  = WithToken __ "(" __ object:Expression __ ")" __ body:Statement {
...
Finally = FinallyToken __ block:Block { return block; }

DebuggerStatement = DebuggerToken EOS { return { type: "DebuggerStatement" }; }
