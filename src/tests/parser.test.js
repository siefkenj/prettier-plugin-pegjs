...
describe("Basic parse", () => {
    ...
    it.only("Parses trivial grammar", () => {
        try {
            let xxx;
            let src = 
'//the real part\n{{a,b,c,dfdasfdasfsafd}}//fffa\n\n\n\n a = b';
console.log("src", src)
...
Grammar
  = __ initializer:(a:Initializer __ {return a})? rules:(a:Rule __ {return a})+ {
...
LabelIdentifier
  = name:Identifier __ ":" {
        ...
        error( "Label can't be a reserved word ", location() );
...
//  __ 
//  displayName:(
//      a:(a:StringLiteral {return createNode("stringliteral", {value: a})})   __ {return a}
//  )? 
//  delimiter:("=" {[1,function(){dd}]}) 
//  __ 
//  expression:Expression 
//  EOS {
//        return createNode( "rule", { name, displayName, expression, delimiter } );
